      ...
      <div className="w-full max-w-[440px] border border-apple-hairline rounded-[18px] bg-apple-canvas p-8 md:p-10 shadow-[0_10px_30px_rgba(0,0,0,0.02)] space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
        ...
        <div className="text-center space-y-3">
          ...
          <div className="space-y-1">
            <h1 className="text-2xl font-semibold text-apple-ink tracking-apple-tight">Sign in with CraftyNOS</h1>
            <p className="text-[14px] text-zinc-500 font-light">Access your isolated virtual Minecraft cluster.</p>
          </div>
        </div>
        ...
        {/* Footnote register navigation */}
        <div className="text-center pt-4 border-t border-zinc-100 text-[13px] text-zinc-500 font-light">
          Don't have an account?{" "}
          <Link href="/register" className="text-apple-primary hover:underline font-semibold transition-all">
            Create yours now
          </Link>
        </div>
